...
interface Violation {
  id: number;
  business_identification_number: string | null; // updated from business_id
  notice_level: number;
  status: string;
...
export default function DashboardPage() {
  ...
  const filtered = useMemo(() => {
    ...
    return violations.filter((v) => {
      ...
      const id = v.business_identification_number ?? "";
    ...
    arr.sort((a, b) => {
      ...
      switch (sortBy.key) {
        ...
        case "status":
          ...
          break;
        default:
          av = a.business_identification_number ?? a.id ?? 0;
          bv = b.business_identification_number ?? b.id ?? 0;
      }
                      ...
                      paginated.map((v) => (
                        ...
                        >
                          <td className="px-6 py-5 font-medium text-black">
                            {v.business_identification_number ?? v.id}
                          </td>
              ...
              {paginated.map((v) => (
                ...
                >
                  <div className="flex justify-between">
                    ...
                    <span className="text-black">{v.business_identification_number ?? v.id}</span>
                  </div>
                  <div className="flex justify-between">
