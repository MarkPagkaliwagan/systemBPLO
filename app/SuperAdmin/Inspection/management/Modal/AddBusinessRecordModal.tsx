...
const emptyRecord = (): Partial<BusinessRecord> => ({
  ...
  "Business Type": null, "Transmittal No.": null,
  "Incharge First Name": null, "Incharge Middle Name": null,
  "Incharge Last Name": null, "Incharge Extension Name": null,
  "Incharge Sex": null, "Citizenship": null,
  "Office Street": null, "Office Region": null, "Office Province": null,
  "Office Municipality": null, "Office Barangay": null, "Office Zipcode": null,
  "Year": null, "Capital": null, "Gross Amount": null,
  "Gross Amount Essential": null, "Gross Amount Non-Essential": null,
  "Reject Remarks": null, "Module Type": null, "Transaction Type": null,
  "Requestor First Name": null, "Requestor Middle Name": null,
  "Requestor Last Name": null, "Requestor Extension Name": null,
  "Requestor Email": null, "Requestor Mobile No.": null,
  "Birth Date": null, "Requestor Sex": null, "Civil Status": null,
  "Requestor Street": null, "Requestor Province": null,
  "Requestor Municipality": null, "Requestor Barangay": null,
  "Requestor Zipcode": null, "Transaction ID": null, "Reference No.": null,
  "Brgy. Clearance Status": null, "SITE Transaction Status": null,
  "CORE Transaction Status": null, "Transaction Date": null,
  "SOA No.": null, "Annual Amount": null, "Term": null,
  "Amount Paid": null, "Balance": null, "Payment Type": null,
  "Payment Date": null, "O.R. No.": null, "Brgy. Clearance No.": null,
  "O.R. Date": null, "Permit No.": null, "Business Plate No.": null,
  "Actual Closure Date": null, "Retirement Reason": null,
  "Source Type": null, violation: null, review_action: null,
  review_date: null, reviewed_by: null, status: "not reviewed",
          ...
          <div
            ...
            <div className="overflow-y-auto flex-1 px-4 py-4 space-y-3">
              ...
              <Section title="Incharge Information" icon={<UserCheck size={16} className="text-blue-600" />} color="bg-blue-50">
                <div className="grid grid-cols-2 gap-3">
                  <Field label="First Name"><input type="text" value={form["Incharge First Name"] ?? ""} onChange={e => set("Incharge First Name", e.target.value)} className={inputCls()} /></Field>
                  <Field label="Middle Name"><input type="text" value={form["Incharge Middle Name"] ?? ""} onChange={e => set("Incharge Middle Name", e.target.value)} className={inputCls()} /></Field>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Last Name"><input type="text" value={form["Incharge Last Name"] ?? ""} onChange={e => set("Incharge Last Name", e.target.value)} className={inputCls()} /></Field>
                  <Field label="Extension"><input type="text" placeholder="Jr., Sr." value={form["Incharge Extension Name"] ?? ""} onChange={e => set("Incharge Extension Name", e.target.value)} className={inputCls()} /></Field>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Sex">
                  ...
                  <Field label="Citizenship"><input type="text" placeholder="e.g. Filipino" value={form["Citizenship"] ?? ""} onChange={e => set("Citizenship", e.target.value)} className={inputCls()} /></Field>
                </div>
              </Section>

              <Section title="Office Address" icon={<MapPin size={16} className="text-orange-500" />} color="bg-orange-50">
                <Field label="Street"><input type="text" value={form["Office Street"] ?? ""} onChange={e => set("Office Street", e.target.value)} className={inputCls()} /></Field>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Region"><input type="text" value={form["Office Region"] ?? ""} onChange={e => set("Office Region", e.target.value)} className={inputCls()} /></Field>
                  <Field label="Province"><input type="text" value={form["Office Province"] ?? ""} onChange={e => set("Office Province", e.target.value)} className={inputCls()} /></Field>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Municipality"><input type="text" value={form["Office Municipality"] ?? ""} onChange={e => set("Office Municipality", e.target.value)} className={inputCls()} /></Field>
                  <Field label="Barangay"><input type="text" value={form["Office Barangay"] ?? ""} onChange={e => set("Office Barangay", e.target.value)} className={inputCls()} /></Field>
                </div>
                <Field label="Zipcode"><input type="text" value={form["Office Zipcode"] ?? ""} onChange={e => set("Office Zipcode", e.target.value)} className={inputCls()} /></Field>
              </Section>

              <Section title="Financial Information" icon={<DollarSign size={16} className="text-emerald-600" />} color="bg-emerald-50">
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Capital (₱)"><input type="number" placeholder="0.00" value={form["Capital"] ?? ""} onChange={e => set("Capital", num(e.target.value))} className={inputCls()} /></Field>
                  <Field label="Gross Amount (₱)"><input type="number" placeholder="0.00" value={form["Gross Amount"] ?? ""} onChange={e => set("Gross Amount", num(e.target.value))} className={inputCls()} /></Field>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Gross Essential (₱)"><input type="number" placeholder="0.00" value={form["Gross Amount Essential"] ?? ""} onChange={e => set("Gross Amount Essential", num(e.target.value))} className={inputCls()} /></Field>
                  <Field label="Gross Non-Essential (₱)"><input type="number" placeholder="0.00" value={form["Gross Amount Non-Essential"] ?? ""} onChange={e => set("Gross Amount Non-Essential", num(e.target.value))} className={inputCls()} /></Field>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Annual Amount (₱)"><input type="number" placeholder="0.00" value={form["Annual Amount"] ?? ""} onChange={e => set("Annual Amount", num(e.target.value))} className={inputCls()} /></Field>
                  <Field label="Amount Paid (₱)"><input type="number" placeholder="0.00" value={form["Amount Paid"] ?? ""} onChange={e => set("Amount Paid", num(e.target.value))} className={inputCls()} /></Field>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Balance (₱)"><input type="number" placeholder="0.00" value={form["Balance"] ?? ""} onChange={e => set("Balance", num(e.target.value))} className={inputCls()} /></Field>
                  <Field label="Term"><input type="text" placeholder="e.g. Annual" value={form["Term"] ?? ""} onChange={e => set("Term", e.target.value)} className={inputCls()} /></Field>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Payment Type"><input type="text" value={form["Payment Type"] ?? ""} onChange={e => set("Payment Type", e.target.value)} className={inputCls()} /></Field>
                  <Field label="Payment Date"><input type="date" value={form["Payment Date"] ?? ""} onChange={e => set("Payment Date", e.target.value)} className={inputCls()} /></Field>
                </div>
                <Field label="Reject Remarks"><input type="text" value={form["Reject Remarks"] ?? ""} onChange={e => set("Reject Remarks", e.target.value)} className={inputCls()} /></Field>
              </Section>

              <Section title="Requestor Information" icon={<User size={16} className="text-purple-600" />} color="bg-purple-50">
                <div className="grid grid-cols-2 gap-3">
                  <Field label="First Name"><input type="text" value={form["Requestor First Name"] ?? ""} onChange={e => set("Requestor First Name", e.target.value)} className={inputCls()} /></Field>
                  <Field label="Middle Name"><input type="text" value={form["Requestor Middle Name"] ?? ""} onChange={e => set("Requestor Middle Name", e.target.value)} className={inputCls()} /></Field>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Last Name"><input type="text" value={form["Requestor Last Name"] ?? ""} onChange={e => set("Requestor Last Name", e.target.value)} className={inputCls()} /></Field>
                  <Field label="Extension"><input type="text" placeholder="Jr., Sr." value={form["Requestor Extension Name"] ?? ""} onChange={e => set("Requestor Extension Name", e.target.value)} className={inputCls()} /></Field>
                </div>
                <Field label="Email"><input type="email" value={form["Requestor Email"] ?? ""} onChange={e => set("Requestor Email", e.target.value)} className={inputCls()} /></Field>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Mobile No."><input type="tel" value={form["Requestor Mobile No."] ?? ""} onChange={e => set("Requestor Mobile No.", e.target.value)} className={inputCls()} /></Field>
                  <Field label="Birth Date"><input type="date" value={form["Birth Date"] ?? ""} onChange={e => set("Birth Date", e.target.value)} className={inputCls()} /></Field>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Sex">
                ...
                <Field label="Street"><input type="text" value={form["Requestor Street"] ?? ""} onChange={e => set("Requestor Street", e.target.value)} className={inputCls()} /></Field>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Province"><input type="text" value={form["Requestor Province"] ?? ""} onChange={e => set("Requestor Province", e.target.value)} className={inputCls()} /></Field>
                  <Field label="Municipality"><input type="text" value={form["Requestor Municipality"] ?? ""} onChange={e => set("Requestor Municipality", e.target.value)} className={inputCls()} /></Field>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Barangay"><input type="text" value={form["Requestor Barangay"] ?? ""} onChange={e => set("Requestor Barangay", e.target.value)} className={inputCls()} /></Field>
                  <Field label="Zipcode"><input type="text" value={form["Requestor Zipcode"] ?? ""} onChange={e => set("Requestor Zipcode", e.target.value)} className={inputCls()} /></Field>
                </div>
              </Section>

              <Section title="Transaction Details" icon={<FileText size={16} className="text-slate-600" />} color="bg-slate-50">
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Transaction ID"><input type="text" value={form["Transaction ID"] ?? ""} onChange={e => set("Transaction ID", e.target.value)} className={inputCls()} /></Field>
                  <Field label="Reference No."><input type="text" value={form["Reference No."] ?? ""} onChange={e => set("Reference No.", e.target.value)} className={inputCls()} /></Field>
                </div>
                <Field label="Transaction Date"><input type="datetime-local" value={form["Transaction Date"] ?? ""} onChange={e => set("Transaction Date", e.target.value)} className={inputCls()} /></Field>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Brgy. Clearance Status"><input type="text" value={form["Brgy. Clearance Status"] ?? ""} onChange={e => set("Brgy. Clearance Status", e.target.value)} className={inputCls()} /></Field>
                  <Field label="Brgy. Clearance No."><input type="text" value={form["Brgy. Clearance No."] ?? ""} onChange={e => set("Brgy. Clearance No.", e.target.value)} className={inputCls()} /></Field>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="SITE Transaction Status"><input type="text" value={form["SITE Transaction Status"] ?? ""} onChange={e => set("SITE Transaction Status", e.target.value)} className={inputCls()} /></Field>
                  <Field label="CORE Transaction Status"><input type="text" value={form["CORE Transaction Status"] ?? ""} onChange={e => set("CORE Transaction Status", e.target.value)} className={inputCls()} /></Field>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="SOA No."><input type="text" value={form["SOA No."] ?? ""} onChange={e => set("SOA No.", e.target.value)} className={inputCls()} /></Field>
                  <Field label="O.R. No."><input type="text" value={form["O.R. No."] ?? ""} onChange={e => set("O.R. No.", e.target.value)} className={inputCls()} /></Field>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="O.R. Date"><input type="date" value={form["O.R. Date"] ?? ""} onChange={e => set("O.R. Date", e.target.value)} className={inputCls()} /></Field>
                  <Field label="Permit No."><input type="text" value={form["Permit No."] ?? ""} onChange={e => set("Permit No.", e.target.value)} className={inputCls()} /></Field>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Business Plate No."><input type="text" value={form["Business Plate No."] ?? ""} onChange={e => set("Business Plate No.", e.target.value)} className={inputCls()} /></Field>
                  <Field label="Source Type"><input type="text" value={form["Source Type"] ?? ""} onChange={e => set("Source Type", e.target.value)} className={inputCls()} /></Field>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <Field label="Actual Closure Date"><input type="date" value={form["Actual Closure Date"] ?? ""} onChange={e => set("Actual Closure Date", e.target.value)} className={inputCls()} /></Field>
                  <Field label="Retirement Reason"><input type="text" value={form["Retirement Reason"] ?? ""} onChange={e => set("Retirement Reason", e.target.value)} className={inputCls()} /></Field>
                </div>
              </Section>

              <Section title="Review & Inspection" icon={<ClipboardList size={16} className="text-red-500" />} color="bg-red-50">
                <Field label="Status">
