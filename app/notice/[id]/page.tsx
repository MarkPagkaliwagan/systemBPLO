...
export default function NoticePage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-100 via-gray-100 to-slate-200 p-4 md:p-8 flex justify-center">
      <div className="bg-white w-full max-w-5xl p-6 md:p-10 rounded-3xl shadow-2xl border border-gray-200">
        ...
        <div className="text-center mb-8 pb-6 border-b">
          ...
          <p className="text-gray-500 text-sm">Tel No. (049) 503-3481 / Email add. bplospc@gmail.com</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
          ...
          <div>
            <label className="block font-semibold text-gray-700 mb-2">BUSINESS AND TAX PAYER NAME:</label>
            <input
              name="taxpayer"
              value={form.taxpayer}
              onChange={handleChange}
        ...
        <div className="bg-green-50 border-l-4 border-green-700 p-5 rounded-2xl mb-5 shadow-sm">
          <p className="text-gray-700 leading-relaxed">
            Please be informed that inspection was conducted at your establishment by the undersigned Inspector of this office and found out the following violations/findings mentioned under The Revised Revenue Code of San Pablo.
          </p>
        </div>
        ...
        <div className="bg-yellow-50 border-l-4 border-yellow-500 p-5 rounded-2xl mb-6 shadow-sm">
          <p className="text-gray-700 leading-relaxed">
            DIRECTIVE: The business establishment owner is directed to personally appear before the Office of the City Mayor, Business Permits and Licensing Division within three (3) working days from the receipt of this notice and to show cause why no cease-and-desist order should be issued against your establishment.
          </p>
        </div>
        ...
        {/* BUTTON */}
        <button className="bg-green-800 hover:bg-green-900 transition text-white px-6 py-3 rounded-xl w-full font-semibold shadow-lg">
          Submit
        </button>
      </div>
    </div>
