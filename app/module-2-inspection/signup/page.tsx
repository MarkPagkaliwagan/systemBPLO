...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f3f4f6] p-4 font-sans text-gray-900">
      <div className="bg-white p-10 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] w-full max-w-md min-h-[620px] flex flex-col justify-between">
        <div>
          <div className="flex justify-center mb-6">
            <div className="w-20 h-20 bg-green-800 rounded-3xl flex items-center justify-center text-white font-black text-xl shadow-lg -rotate-3 hover:rotate-0 transition-transform duration-300">
              LOGO
            </div>
          </div>
          ...
          <form onSubmit={(e) => e.preventDefault()} className="space-y-3">
            ...
            <button
              type="submit"
              className="w-full bg-green-800 text-white p-4 rounded-2xl font-bold text-lg hover:bg-green-900 shadow-[0_10px_20px_rgba(20,83,45,0.2)] hover:shadow-none transition-all active:scale-[0.98] mt-4"
            >
              Get Started
            </button>
          </form>
        ...
        <div className="mt-auto pt-6 text-center">
          <Link href="/module-2-inspection/login" className="text-gray-500 hover:text-green-800 font-medium transition-colors text-sm">
